(function () {
    ...
    var t = {
        en: {
            ...
            team_intro: '<strong>We do our best to let our product help as many people as possible.</strong>',
        ...
        ja: {
            ...
            hw5: '• 3月ベータMVP予定',
            team_title: 'チームメンバー',
            team_intro: '<strong>私たちの製品ができるだけ多くの人々を支援できるよう、最善を尽くしています。</strong>',
