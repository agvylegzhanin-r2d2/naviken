(function () {
    ...
    var t = {
        en: {
            ...
            info_sub: 'Next-generation site safety powered by UWB.',
            hero_title: 'AI-Driven Site Safety to Prevent Machinery Collisions',
            ...
            serve_lead: 'GenbaSense helps construction companies reduce accidents, insurance costs, and downtime with wearable safety technology built for real site conditions.',
            serve1_title: 'General contractors',
            serve1_text: 'Lower accident rates and work stoppages with site-wide proximity awareness across crews and equipment.',
            serve2_title: 'Subcontractors',
            serve2_text: 'Protect workers in high-risk zones with haptic alerts that work when visibility and communication are limited.',
            serve3_title: 'Site managers & safety officers',
            serve3_text: 'Collect hot-zone analytics and evidence for ISO\u00a045001 compliance and proactive risk management.',
            serve4_title: 'Equipment operators',
            serve4_text: 'Reduce blind-spot collisions with workers who receive instant tactile warnings before impact.',
            ...
            step1_text: 'AI-powered UWB anchors track worker and equipment positions in real time—without network connectivity.',
            ...
            stat1_label: 'Non-fatal injury cases per year in Japan',
            stat2_label: 'Of daily wages paid for lost workdays after accidents',
            stat3_label: 'Compensation range for serious injuries',
            stat4_label: 'UWB positioning range—from centimeters to site scale',
            ...
            team_title: 'Team',
            team_lead: 'GenbaSense is developed at OIST Innovation with a multidisciplinary founding team.',
        ...
        ja: {
            ...
            info_sub: 'UWBが実現する、次世代の現場安全。',
            hero_title: 'AIによる現場安全で、重機衝突を防ぐ',
            ...
            serve_eyebrow: '対象顧客',
            serve_title: 'サービス対象',
            serve_lead: 'GenbaSenseは、実際の現場条件向けに設計されたウェアラブル安全技術で、事故・保険コスト・ダウンタイムの削減を支援します。',
            serve1_title: 'ゼネコン',
            serve1_text: '現場全体の接近認識により、クルーと機械の事故率と作業停止を低減。',
            serve2_title: '下請け業者',
            serve2_text: '視界・通信が制限される高リスクゾーンでも有効なハプティック警報で作業員を保護。',
            serve3_title: '現場管理者・安全担当',
            serve3_text: 'ホットゾーン分析とISO 45001コンプライアンスの証拠、能動的リスク管理を支援。',
            serve4_title: '重機オペレーター',
            serve4_text: '衝突前に触覚警告を受ける作業員とのブラインドスポット衝突を低減。',
            ...
            step1_text: 'AI搭載UWBアンカーがネットワーク不要で作業員と機械の位置をリアルタイム追跡。',
            ...
            stat1_label: '日本の年間非致死傷害件数',
            stat2_label: '事故後の休業日に支払われる日給の割合',
            stat3_label: '重傷時の賠償額の範囲',
            stat4_label: 'UWB測位範囲—センチメートルから現場規模まで',
            cases_eyebrow: '導入事例',
            cases_title: 'ユースケース',
            ...
            hw5: '• 3月ベータMVP予定',
            team_title: 'チーム',
            team_lead: 'GenbaSenseはOIST Innovationで、多分野の創業チームにより開発されています。',
            funding_title: '資金調達',
